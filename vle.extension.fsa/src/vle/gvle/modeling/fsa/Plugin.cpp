...
bool PluginFSA::create(vpz::AtomicModel& model,
    vpz::Dynamic& /*dynamic*/,
...
void PluginFSA::generateObservables(vpz::AtomicModel& model,
                                    vpz::Observables& observables)
{
    std::string observableName((fmt("obs_FSA_%1%") % model.getName()).str());
...
void PluginFSA::generateStructure(vpz::AtomicModel& atom)
{
...
bool PluginFSA::modify(vpz::AtomicModel& model,
    vpz::Dynamic& /*dynamic*/,
    vpz::Conditions& /*conditions*/,
    vpz::Observables& observables,
